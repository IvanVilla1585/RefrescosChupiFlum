...
urlpatterns = [
    ...
    url(r'^api/', include('productos.urls', namespace='api_productos')),
    url(r'^api/', include('maquina.urls', namespace='api_maquinas')),
    url(r'^api/', include('materiaprima.urls', namespace='api_materia_prima')),
    url(r'^api/', include('categorias.urls', namespace='api_categoria')),
    url(r'^api/', include('categoriasmateriaprima.urls', namespace='api_categoria_materia_prima')),
    url(r'^api/', include('proceso.urls', namespace='api_procesos')),
    url(r'^api/', include('userprofiles.urls', namespace='api_usuarios')),
    url(r'^api/', include('proveedores.urls', namespace='api_provedores')),
]
