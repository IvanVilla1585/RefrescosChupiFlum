...
var ProductoTer = function () {
  function ProductoTer() {
    ...
    this.$consulta_nom = $('#consulta_nom');
  ...
  _createClass(ProductoTer, [{
    ...
    value: function activarInputConsulta() {
      ...
      this.$consultar_pro.css('display', 'block');
      this.$errors.empty();
    }
  }, {
    ...
    value: function desactivarInputConsulta() {
      ...
      this.$consultar_pro.css('display', 'none');
      this.$errors.empty();
    }
  }, {
    ...
    value: function limpiarFormulario() {
      ...
      this.$categoria.val("0");
      this.$costo_produccion.val("");
      this.$precio_venta.val("");
      this.$cantidad.val("");
    }
  }, {
    ...
    value: function activarFormulario() {
      ...
      this.$costo_produccion.removeAttr("disabled");
      this.$precio_venta.removeAttr("disabled");
...
var _index3 = require('./ProductoTer/index.js');

var _index4 = _interopRequireDefault(_index3);

var _index5 = require('./materiaprima/index.js');
...
var Maquina = function () {
  function Maquina() {
    ...
    this.$consultar_maquin = $('#consultar_maquin');
    this.$consultar_maq = $('#consultar_maq');
    this.$input_consulta = $('#input_consulta');
    this.$modal_boton = $('#modal_boton');
    this.$nombre = $('#id_nombre');
    this.$descripcion = $('#id_descripcion');
  ...
  _createClass(Maquina, [{
    ...
    value: function escucharBuscar() {
      ...
      this.$buscarMa.on('click', function (evt) {
        evt.preventDefault();
        _this3.activarInputConsulta();
        _this3.$title_modal.empty().text('Consultar');
        _this3.accion = _this3.$title_modal.text();
    ...
    value: function activarInputConsulta() {
      this.$input_consulta.css('display', 'block');
      this.$consultar_maquin.css('display', 'block');
    }
  }, {
    key: 'desactivarInputConsulta',
    value: function desactivarInputConsulta() {
      this.$input_consulta.css('display', 'none');
      this.$consultar_maquin.css('display', 'none');
    }
  }, {
    key: 'llenarFormulario',
    value: function llenarFormulario(data) {
      debugger;
      this.$nombre.focus();
      this.$nombre.val(data.maquina.nombre);
      this.$descripcion.focus();
    ...
    value: function escucharModificar() {
      ...
      this.$modificarMa.on('click', function (evt) {
        evt.preventDefault();
        _this7.activarInputConsulta();
        _this7.$title_modal.empty().text('Modificar');
        _this7.$text_modal.empty().text('Ingrese el nombre del producto a modificar');
    ...
    value: function escucharEliminar() {
      ...
      this.$eliminarMa.on('click', function (evt) {
        evt.preventDefault();
        _this8.activarInputConsulta();
        _this8.$title_modal.empty().text('Eliminar');
        _this8.$text_modal.empty().text('Ingrese el nombre del producto a eliminar');
...
var MateriaPrima = function () {
  function MateriaPrima() {
    _classCallCheck(this, MateriaPrima);
    ...
    this.$unidad_medida = $('#id_unidad_medida');
    this.$categoria = $('#id_categoria');
    this.$cantidad_entrada = $('#id_cantidad_entrada');
    this.$cantidad = $('#id_cantidad');
    this.$errors = $('#errors');
  ...
  _createClass(MateriaPrima, [{
    ...
    value: function escucharBuscar() {
      ...
      this.$buscarMP.on('click', function (evt) {
        evt.preventDefault();
        _this3.activarInputConsulta();
        _this3.$title_modal.empty().text('Consultar');
        _this3.accion = _this3.$title_modal.text();
    ...
    value: function peticion(url) {
      ...
      $.get(url, function (data) {
        ...
        if (_this5.$title_modal.text() != 'Eliminar') {
          _this5.llenarFormulario(data);
          if (_this5.$title_modal.text() == 'Modificar') {
            _this5.$formulario_materia.attr('action', '/MenuPrincipal/MateriaPrima/Modificar/' + _this5.id + '/');
          }
        }
      });
    }
    ...
    value: function escucharLimpiar() {
      ...
      this.$limpiarMP.on('click', function (evt) {
        evt.preventDefault();
        _this6.$nombre.val("");
        _this6.$descripcion.val("");
        _this6.$categoria.val("");
        _this6.$cantidad_entrada.val("");
        _this6.$unidad_medida.val("");
        _this6.$cantidad.val("");
        _this6.activarFormulario();
      });
    }
    ...
    value: function escucharModificar() {
      ...
      this.$modificarMP.on('click', function (evt) {
        evt.preventDefault();
        _this7.activarInputConsulta();
        _this7.$title_modal.empty().text('Modificar');
        _this7.$text_modal.empty().text('Ingrese el nombre del producto a modificar');
    ...
    value: function escucharEliminar() {
      ...
      this.$eliminarMP.on('click', function (evt) {
        evt.preventDefault();
        _this8.activarInputConsulta();
        _this8.$title_modal.empty().text('Eliminar');
        _this8.$text_modal.empty().text('Ingrese el nombre del producto a eliminar');
...
var Proveedor = function () {
  ...
  _createClass(Proveedor, [{
    ...
    value: function escucharGuardar() {
      ...
      this.$guardar.on('click', function (evt) {
        var errors = false;
        var string = '';
        var template = '<p>:error:</p>';
        var nit = _this.$nit.val();
        var nombre_empresa = _this.$nombre_empresa.val();
        var telefono = _this.$telefono.val();
        var direccion = _this.$direccion.val();
        var nombre_contacto = _this.$nombre_contacto.val();
        var telefono_contacto = _this.$telefono_contacto.val();
        if (nit.trim() == "") {
          string += template.replace(':error:', 'El campo nit es obligatorio');
          errors = true;
        }
        if (nombre_empresa.trim() == "") {
          string += template.replace(':error:', 'El campo nombre de la empresa es obligatorio');
          errors = true;
        }
        if (telefono.trim() == "") {
          string += template.replace(':error:', 'El campo télefono es obligatorio');
          errors = true;
        }
        if (direccion.trim() == "") {
          string += template.replace(':error:', 'El campo dirección es obligatorio');
          errors = true;
        }
        if (nombre_contacto.trim() == "") {
          string += template.replace(':error:', 'El campo nombre contacto es obligatorio');
          errors = true;
        }
        if (telefono_contacto.trim() == "") {
          string += template.replace(':error:', 'El campo télefono contacto es obligatorio');
          errors = true;
        }
        if (errors) {
          evt.preventDefault();
          _this.desactivarInputConsulta();
          _this.$text_modal.empty().text();
          _this.$title_modal.empty().text('Alerta');
          _this.$errors.append(string);
    ...
    value: function activarInputConsulta() {
      this.$input_consulta.css('display', 'block');
      this.$consultar_prove.css('display', 'block');
      this.$errors.empty();
    }
  }, {
    key: 'desactivarInputConsulta',
    value: function desactivarInputConsulta() {
      this.$input_consulta.css('display', 'none');
      this.$consultar_prove.css('display', 'none');
      this.$errors.empty();
    }
  }, {
    key: 'llenarFormulario',
    value: function llenarFormulario(data) {
      ...
      this.$correo_empresa.focus();
      this.$correo_empresa.val(data.proveedor.correo_empresa);
      this.$nombre_contacto.focus();
      this.$nombre_contacto.val(data.proveedor.nombre_contacto);
      this.$apellido_contacto.focus();
      this.$apellido_contacto.val(data.proveedor.apellido_contacto);
      this.$telefono_contacto.focus();
      this.$telefono_contacto.val(data.proveedor.telefono_contacto);
      this.$correo_contacto.focus();
      this.$correo_contacto.val(data.proveedor.correo_contacto);
      if (this.accion == 'Consultar') {
        this.desactivarFormulario();
      } else {
        this.activarFormulario();
        this.$nit.attr('readonly', 'readonly');
      }
    }
  }, {
    key: 'limpiarFormulario',
    ...
    value: function desactivarFormulario() {
      ...
      this.$apellido_contacto.attr('disabled', 'disabled');
    ...
    value: function activarFormulario() {
      ...
      this.$apellido_contacto.removeAttr("disabled");
    ...
    value: function escucharLimpiar() {
      ...
      this.$limpiar.on('click', function (evt) {
        evt.preventDefault();
        _this7.$nit.val("");
        _this7.$nombre_empresa.val("");
        _this7.$direccion.val("");
        _this7.$telefono.val("");
        _this7.$fax.val("");
        _this7.$correo_empresa.val("");
        _this7.$nombre_contacto.val("");
        _this7.$apellido_contacto.val("");
        _this7.$telefono_contacto.val("");
        _this7.$correo_contacto.val("");
      });
    }
  }, {
    key: 'escucharModificar',
